...
namespace RestaurantTableBookingFunctionApp
{
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    using (SqlDataReader reader = await getLastReservationDateCommand.ExecuteReaderAsync())
                    {
                        while (await reader.ReadAsync())
                        {
                            ...
                            DateTime? lastReservationDate = reader["LastReservationDate"] as DateTime?;
                    ...
                    foreach (var data in branchData)
                    {
                        ...
                        DateTime lastReservationDate = data.LastReservationDate ?? DateTime.MinValue;
